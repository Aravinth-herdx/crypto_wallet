...
class _AccountDetailsScreenState extends ConsumerState<AccountDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        middle: Text('Account Details: ${widget.account.name}'),
      ),
      child: SafeArea(
        child: ListView(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            widget.account.isImported ? 'Imported Wallet' : 'Created Wallet',
            style: TextStyle(
  ...
  Widget _buildAddressSection() {
    final formattedAddress = '${widget.account.address.substring(0, 6)}...${widget.account.address.substring(widget.account.address.length - 4)}';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Full Address: ${widget.account.address}',
            style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          CupertinoButton(
            ...
            child: Text(_showPrivateKey ? 'Hide Private Key' : 'Reveal Private Key'),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  CupertinoButton(
                    padding: EdgeInsets.zero,
                    child: const Icon(CupertinoIcons.doc_on_doc, color: CupertinoColors.destructiveRed),
                    onPressed: () => _copyToClipboard(widget.account.privateKey ?? ''),
                  ),
                ],
              ),
            ),
